    ...
    <>
        <div className='flex flex-row w-full h-screen font-mono'>
            ...
            <div className='text-left justify-self-start mt-32 ml-10 mr-10 md:ml-32 lg:ml-48'>
                <p className='text-emerald-400 text-left md:mb-2 lg:mb-4'>Hi, my name is </p>
                <h2 className='text-[1.65rem] md:text-5xl lg:text-7xl text-left text-slate-200 font-sans font-semibold mb-4 md:h-16 lg:h-24'>Saugat Bhandari.</h2>
                <h4 className='text-xl md:text-4xl lg:text-[3.5rem] text-left text-neutral-400 font-sans font-semibold mb-4 md:h-16 lg:h-24'>Passionate, Creative, Innovative.</h4>
                <p className='text-left text-neutral-400 font-sans font-semibold text-sm mb-8'>I&apos;m a web developer possessing a diverse skillset, including proficiency <br /> in programming languages and tools, a passion for problem-solving, <br /> and creativity in design. Currently focused at <a href="http://www.neutrosys.com/" target='_blank' className='text-emerald-400 hover:decoration-emerald-400 hover:underline' rel="noreferrer">Neutrosys.</a></p>
                <a href="https://github.com/saugat23" target='_blank' rel="noreferrer" className='text-sm md:text-xl lg:text-2xl'><button className='border-2 border-emerald-400 md:px-5 py-1 px-2 hover:bg-emerald-400 hover:text-[#1B2430] text-emerald-400'>Check out my project</button></a>
            </div>
