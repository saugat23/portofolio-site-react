...
const Contacts = () => {
  ...
  return (
    <>
      <div className="h-screen p-2 md:p-20 lg:p-40 md:relative relative" id="contact">
        ...
        <div className='flex justify-center items-center flex-col'>
            ...
            <p className='text-sm font-normal text-slate-400 leading-6 text-center'>I’m not currently looking for any new opportunities, so my inbox is <br />always open. Whether you have a question or just want to say hi, <br />I’ll try my best to get back to you!</p>
